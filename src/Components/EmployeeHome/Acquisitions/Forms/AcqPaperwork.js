                ...
                <Toolbar sx={{ width: '100%', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <Grid container style={{ marginTop: '1em' }} spacing={4}>
                        ...
                        <Grid item xs={12} sm={6} >
                            ...
                            <FormControl sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '3em', mt: 3 }}>
                    ...
                    <Grid item xs={12} sm={6} >
                        ...
                        <Grid item xs={12}>
                            <Box style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', }}>
                                {propertyData.emailBlast === true && propertyData.market === '' && 
                                    <h1 className='align-center text-lg text-red-500 font-semibold'>Market must be selected to blast property</h1>
